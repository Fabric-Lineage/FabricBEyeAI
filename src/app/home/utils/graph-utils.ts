...
export const FABRIC_COLORS = {
  ...
  REPORT: '#F2C811', // Power BI Report gold
  PAGINATED_REPORT: '#CA5010', // Paginated Report burnt orange
  DASHBOARD: '#E8740C', // Fabric Dashboard orange
  SEMANTIC_MODEL: '#1A6DD4', // Fabric Semantic Model blue

  // Data Integration
  DATAFLOW: '#4CAF50', // Dataflow green
  DATAFLOW_GEN2: '#4CAF50', // Dataflow green
  PIPELINE: '#8661C5', // Fabric Data Factory purple

  // Data Engineering
  LAKEHOUSE: '#00B7C3', // Fabric Data Engineering teal
  DATA_WAREHOUSE: '#005BA1', // Data Warehouse deep blue
  SQL_ENDPOINT: '#005BA1', // SQL Endpoint (same as warehouse)
  NOTEBOOK: '#D83B01', // Spark Notebook orange-red
  SPARK_JOB: '#D83B01', // Spark family orange-red

  // Real-Time Intelligence
  EVENTSTREAM: '#008575', // Real-Time Intelligence teal-green
  EVENTHOUSE: '#008575', // Real-Time Intelligence teal-green
  KQL_DATABASE: '#0078D4', // Kusto blue
  KQL_QUERYSET: '#0078D4', // Kusto blue

  // Other
  DATAMART: '#8661C5', // Datamart purple
  ML_MODEL: '#742774', // AI/ML purple
  ML_EXPERIMENT: '#742774', // AI/ML purple
  APP: '#737373', // App gray
